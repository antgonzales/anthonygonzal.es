...
describe('getExcerpt()', () => {
  ...
  describe('with inline markdown syntax', () => {
    it('strips markdown links', () => {
      const body = 'I am a [Product Engineer](https://example.com) based in New York.';
      expect(getExcerpt(body)).toBe('I am a Product Engineer based in New York.');
    });
  ...
  describe('with line breaks within a paragraph', () => {
    it('collapses newlines into spaces', () => {
      ...
      expect(getExcerpt(body)).toBe('This is a paragraph that spans multiple lines.');
    });
  });
